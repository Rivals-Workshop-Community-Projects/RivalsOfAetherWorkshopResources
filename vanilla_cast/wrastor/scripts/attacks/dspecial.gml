...
set_window_value(AT_DSPECIAL, AG_WINDOW_H_BOOST_2_WIND, 12);
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_bird_downspecial_end"));
...
//ERROR_NO_SETTER_FOUND(AT_DSPECIAL, NUM_UNIQUE_HITBOXES, 2);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_KNOCKBACK_SCALING, 0.20);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HITSTUN_MULTIPLIER, 1.20);
