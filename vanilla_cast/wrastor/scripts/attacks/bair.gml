...
set_hitbox_value(AT_BAIR, 1, HG_KNOCKBACK_SCALING, 0.80);
...
set_hitbox_value(AT_BAIR, 1, HG_HITSTUN_MULTIPLIER, 0.80);
set_hitbox_value(AT_BAIR, 2, HG_HITSTUN_MULTIPLIER, 0.80);
