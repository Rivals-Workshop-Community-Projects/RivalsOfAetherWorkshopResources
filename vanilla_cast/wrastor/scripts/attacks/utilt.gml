...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX_FRAME, 13);
...
set_hitbox_value(AT_UTILT, 3, HG_KNOCKBACK_SCALING, 0.60);
...
set_hitbox_value(AT_UTILT, 2, HG_HEIGHT, 25);
set_hitbox_value(AT_UTILT, 3, HG_WIDTH, 8);
set_hitbox_value(AT_UTILT, 3, HG_HEIGHT, 8);
...
set_hitbox_value(AT_UTILT, 3, HG_HITBOX_Y, -5);
...
set_hitbox_value(AT_UTILT, 1, HG_HITSTUN_MULTIPLIER, 0.80);
set_hitbox_value(AT_UTILT, 2, HG_HITSTUN_MULTIPLIER, 0.80);
...
set_hitbox_value(AT_UTILT, 2, HG_HITPAUSE_SCALING, 0.80);
...
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT, 19);
