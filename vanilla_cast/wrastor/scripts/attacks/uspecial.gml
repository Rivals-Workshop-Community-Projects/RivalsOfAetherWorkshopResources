...
//ERROR_NO_SETTER_FOUND(AT_USPECIAL, NUM_UNIQUE_HITBOXES, 3);
...
set_hitbox_value(AT_USPECIAL, 3, HG_KNOCKBACK_SCALING, 0.50);
...
set_hitbox_value(AT_USPECIAL, 2, HG_VISUAL_EFFECT, 146);
set_hitbox_value(AT_USPECIAL, 3, HG_VISUAL_EFFECT, 147);
