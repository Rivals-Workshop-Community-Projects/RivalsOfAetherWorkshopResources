...
//ERROR_NO_SETTER_FOUND(AT_FAIR, NUM_UNIQUE_HITBOXES, 3);
...
set_hitbox_value(AT_FAIR, 1, HG_KNOCKBACK_SCALING, 0.60);
set_hitbox_value(AT_FAIR, 2, HG_KNOCKBACK_SCALING, 0.40);
set_hitbox_value(AT_FAIR, 3, HG_KNOCKBACK_SCALING, 0.50);
...
set_hitbox_value(AT_FAIR, 3, HG_HITSTUN_MULTIPLIER, 0.85);
...
set_hitbox_value(AT_FAIR, 1, HG_HITPAUSE_SCALING, 0.15);
set_hitbox_value(AT_FAIR, 2, HG_HITPAUSE_SCALING, 0.15);
...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT, 146);
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT, 11);
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT, 11);
