...
ERROR_NO_SETTER_FOUND(AT_NAIR, 2, FINAL_BASE_KNOCKBACK, 3);
set_hitbox_value(AT_NAIR, 1, HG_KNOCKBACK_SCALING, 0.20);
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, 0.60);
...
set_hitbox_value(AT_NAIR, 1, HG_HITSTUN_MULTIPLIER, 0.70);
...
set_hitbox_value(AT_NAIR, 1, HG_HITPAUSE_SCALING, 0.20);
set_hitbox_value(AT_NAIR, 2, HG_HITPAUSE_SCALING, 0.70);
