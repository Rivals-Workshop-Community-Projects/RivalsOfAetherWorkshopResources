...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_syl_dspecial_howl"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_LENGTH, 0);
...
set_window_value(AT_DSPECIAL, 5, AG_WINDOW_LENGTH, 0);
...
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_LENGTH, 0);
...
//ERROR_NO_SETTER_FOUND(AT_DSPECIAL, NUM_UNIQUE_HITBOXES, 1);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.20);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 74);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, 132);
...
//ERROR_NO_SETTER_FOUND(AT_DSPECIAL, PROJECTILE_LIFETIME, 2);
