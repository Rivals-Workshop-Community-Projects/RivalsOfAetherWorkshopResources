...
//ERROR_NO_SETTER_FOUND(AT_FAIR, HAS_WHIFF_LANDING, 2);
...
set_hitbox_value(AT_FAIR, 1, HG_WIDTH, 122);
set_hitbox_value(AT_FAIR, 1, HG_HEIGHT, 122);
set_hitbox_value(AT_FAIR, 2, HG_WIDTH, 90);
set_hitbox_value(AT_FAIR, 2, HG_HEIGHT, 122);
...
set_hitbox_value(AT_FAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 14);
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, 14);
