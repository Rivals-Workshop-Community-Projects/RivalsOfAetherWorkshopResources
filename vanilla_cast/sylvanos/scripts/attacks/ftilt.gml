...
set_hitbox_value(AT_FTILT, 1, HG_KNOCKBACK_SCALING, 0.20);
...
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, 132);
...
//ERROR_NO_SETTER_FOUND(AT_FTILT, 2, PROJECTILE_LIFETIME, 21);
