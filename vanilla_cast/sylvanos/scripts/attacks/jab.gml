...
set_window_value(AT_JAB, 7, AG_WINDOW_HSPEED, 0);
...
set_window_value(AT_JAB, 10, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_JAB, 10, AG_WINDOW_SFX, asset_get("sfx_swipe_heavy2"));
...
set_window_value(AT_JAB, 12, AG_WINDOW_LENGTH, 9);
...
set_window_value(AT_JAB, 12, AG_WINDOW_SFX, asset_get("sfx_syl_nspecial"));
set_window_value(AT_JAB, 12, AG_WINDOW_SFX_FRAME, 8);
set_window_value(AT_JAB, 12, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_JAB, 12, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_JAB, 13, AG_WINDOW_LENGTH, 30);
set_window_value(AT_JAB, 13, AG_WINDOW_HSPEED, 0);
set_window_value(AT_JAB, 13, AG_WINDOW_VSPEED, 0);
set_window_value(AT_JAB, 13, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_JAB, 13, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_JAB, 13, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_JAB, 13, AG_WINDOW_SFX, 0);
set_window_value(AT_JAB, 13, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_JAB, 13, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_JAB, 13, AG_WINDOW_INVINCIBILITY, 0);
//ERROR_NO_SETTER_FOUND(AT_JAB, HAS_COOLDOWN, 0);
//ERROR_NO_SETTER_FOUND(AT_JAB, COOLDOWN, 0);
set_num_hitboxes(AT_JAB, 5);
//ERROR_NO_SETTER_FOUND(AT_JAB, NUM_UNIQUE_HITBOXES, 5);
...
set_hitbox_value(AT_JAB, 5, HG_WINDOW, 13);
...
set_hitbox_value(AT_JAB, 5, HG_LIFETIME, 9000);
...
set_hitbox_value(AT_JAB, 5, HG_KNOCKBACK_SCALING, 0.35);
...
set_hitbox_value(AT_JAB, 3, HG_HITBOX_X, 91);
set_hitbox_value(AT_JAB, 3, HG_HITBOX_Y, -38);
set_hitbox_value(AT_JAB, 4, HG_HITBOX_X, 91);
...
set_hitbox_value(AT_JAB, 3, HG_HITSTUN_MULTIPLIER, 0.75);
set_hitbox_value(AT_JAB, 4, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_JAB, 5, HG_HITSTUN_MULTIPLIER, 0.50);
...
set_hitbox_value(AT_JAB, 3, HG_HITPAUSE_SCALING, 0.30);
set_hitbox_value(AT_JAB, 4, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_JAB, 5, HG_HITPAUSE_SCALING, 0.10);
...
set_hitbox_value(AT_JAB, 5, HG_VISUAL_EFFECT, 132);
...
set_hitbox_value(AT_JAB, 4, HG_HIT_SFX, 0);
set_hitbox_value(AT_JAB, 5, HG_HIT_SFX, asset_get("sfx_leafy_hit1"));
...
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_HSPEED, 4);
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_VSPEED, -4);
set_hitbox_value(AT_JAB, 5, HG_PROJECTILE_GRAVITY, 0.60);
//ERROR_NO_SETTER_FOUND(AT_JAB, 5, PROJECTILE_LIFETIME, 9000);
