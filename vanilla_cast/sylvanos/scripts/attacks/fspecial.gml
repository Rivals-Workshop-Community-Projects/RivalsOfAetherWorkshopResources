...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_syl_fspecial_bite"));
...
set_window_value(AT_FSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_bite"));
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_bite"));
...
set_window_value(AT_FSPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_forsburn_consume_fail"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, 131);
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT, 0);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT_X_OFFSET, 28);
set_hitbox_value(AT_FSPECIAL, 2, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT_Y_OFFSET, 12);
