...
//ERROR_NO_SETTER_FOUND(AT_UAIR, HAS_WHIFF_LANDING, 0);
//ERROR_NO_SETTER_FOUND(AT_UAIR, AUTOCANCEL_FRAME, 24);
...
set_hitbox_value(AT_UAIR, 1, HG_HITSTUN_MULTIPLIER, 1.60);
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -28);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -28);
