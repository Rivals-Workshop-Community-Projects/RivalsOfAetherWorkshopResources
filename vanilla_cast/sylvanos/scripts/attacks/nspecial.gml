...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, 132);
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT, 132);
...
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, 1, PROJECTILE_LIFETIME, 9000);
...
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, 2, PROJECTILE_LIFETIME, 2);
