...
set_window_value(AT_DAIR, 5, AG_WINDOW_SFX, asset_get("sfx_land"));
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, 134);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, 135);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 18);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 12);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 18);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, 24);
