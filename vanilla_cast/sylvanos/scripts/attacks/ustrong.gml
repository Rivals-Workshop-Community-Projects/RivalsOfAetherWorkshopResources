...
set_window_value(AT_USTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_land"));
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_X, 140);
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -154);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_X, 101);
set_hitbox_value(AT_USTRONG, 2, HG_HITBOX_Y, -97);
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_X, 59);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, 162);
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, 134);
set_hitbox_value(AT_USTRONG, 3, HG_VISUAL_EFFECT, 134);
