...
set_hitbox_value(AT_UTILT, 1, HG_KNOCKBACK_SCALING, 0.70);
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, 0.35);
set_hitbox_value(AT_UTILT, 3, HG_KNOCKBACK_SCALING, 0.70);
...
set_hitbox_value(AT_UTILT, 3, HG_WIDTH, 124);
set_hitbox_value(AT_UTILT, 3, HG_HEIGHT, 26);
...
set_hitbox_value(AT_UTILT, 1, HG_HITPAUSE_SCALING, 0.40);
set_hitbox_value(AT_UTILT, 2, HG_HITPAUSE_SCALING, 0.20);
set_hitbox_value(AT_UTILT, 3, HG_HITPAUSE_SCALING, 0.40);
...
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT, 21);
