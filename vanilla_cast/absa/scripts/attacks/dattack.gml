...
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, 20);
set_hitbox_value(AT_DATTACK, 2, HG_VISUAL_EFFECT, 20);
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_absa_singlezap2"));
