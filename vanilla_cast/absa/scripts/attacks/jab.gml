...
set_window_value(AT_JAB, 4, AG_WINDOW_SFX, 0);
...
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT, 22);
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, 22);
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT_X_OFFSET, 10);
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT_Y_OFFSET, 6);
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT_Y_OFFSET, 6);
set_hitbox_value(AT_JAB, 1, HG_HIT_SFX, asset_get("sfx_absa_singlezap2"));
