...
ERROR_NO_SETTER_FOUND(AT_DSPECIAL, MAX_CHARGE_TIME, 35);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_KNOCKBACK_SCALING, 1.50);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITPAUSE_SCALING, 0.60);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_absa_orb_hit"));
...
//ERROR_NO_SETTER_FOUND(AT_DSPECIAL, PROJECTILE_LIFETIME, 105);
