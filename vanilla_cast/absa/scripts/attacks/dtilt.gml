...
//ERROR_NO_SETTER_FOUND(AT_DTILT, NUM_UNIQUE_HITBOXES, 1);
...
set_hitbox_value(AT_DTILT, 1, HG_HITPAUSE_SCALING, 0.60);
...
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_Y_OFFSET, 25);
