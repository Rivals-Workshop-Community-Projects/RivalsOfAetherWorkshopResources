...
set_hitbox_value(AT_NAIR, 5, HG_KNOCKBACK_SCALING, 0.30);
...
set_hitbox_value(AT_NAIR, 5, HG_HITPAUSE_SCALING, 0.20);
...
set_hitbox_value(AT_NAIR, 4, HG_VISUAL_EFFECT, 20);
set_hitbox_value(AT_NAIR, 5, HG_VISUAL_EFFECT, 21);
