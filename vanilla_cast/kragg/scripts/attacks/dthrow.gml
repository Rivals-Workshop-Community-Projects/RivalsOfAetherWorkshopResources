set_attack_value(AT_DTHROW, AG_CATEGORY, 3);
...
set_window_value(AT_DTHROW, 1, AG_WINDOW_HSPEED, 0);
set_window_value(AT_DTHROW, 1, AG_WINDOW_VSPEED, 0);
set_window_value(AT_DTHROW, 1, AG_WINDOW_HSPEED_TYPE, 0);
...
set_window_value(AT_DTHROW, 1, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_DTHROW, 1, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_DTHROW, 2, AG_WINDOW_LENGTH, 2);
set_window_value(AT_DTHROW, 2, AG_WINDOW_HSPEED, 0);
set_window_value(AT_DTHROW, 2, AG_WINDOW_VSPEED, -6);
set_window_value(AT_DTHROW, 2, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_DTHROW, 2, AG_WINDOW_VSPEED_TYPE, 1);
set_window_value(AT_DTHROW, 2, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_DTHROW, 2, AG_WINDOW_SFX, 0);
set_window_value(AT_DTHROW, 2, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_DTHROW, 2, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_DTHROW, 2, AG_WINDOW_INVINCIBILITY, 0);
...
set_window_value(AT_DTHROW, 3, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_DTHROW, 3, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_DTHROW, 3, AG_WINDOW_SFX, 0);
set_window_value(AT_DTHROW, 3, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_DTHROW, 3, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_DTHROW, 3, AG_WINDOW_INVINCIBILITY, 0);
//ERROR_NO_SETTER_FOUND(AT_DTHROW, HAS_COOLDOWN, 0);
//ERROR_NO_SETTER_FOUND(AT_DTHROW, COOLDOWN, 0);
set_num_hitboxes(AT_DTHROW, 1);
//ERROR_NO_SETTER_FOUND(AT_DTHROW, NUM_UNIQUE_HITBOXES, 1);
//set_hitbox_value(AT_DTHROW, 1, NUM, 0);
...
set_hitbox_value(AT_DTHROW, 1, HG_LIFETIME, 999999);
set_hitbox_value(AT_DTHROW, 1, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_DTHROW, 1, HG_KNOCKBACK_SCALING, 0.40);
...
set_hitbox_value(AT_DTHROW, 1, HG_HITBOX_X, 5);
...
set_hitbox_value(AT_DTHROW, 1, HG_HITSTUN_MULTIPLIER, 0.80);
...
set_hitbox_value(AT_DTHROW, 1, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_DTHROW, 1, HG_VISUAL_EFFECT, 193);
...
set_hitbox_value(AT_DTHROW, 1, HG_EXTRA_CAMERA_SHAKE, 2);
set_hitbox_value(AT_DTHROW, 1, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_DTHROW, 1, HG_HIT_LOCKOUT, 0);
set_hitbox_value(AT_DTHROW, 1, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_DTHROW, 1, HG_HITBOX_GROUP, 0);
...
set_hitbox_value(AT_DTHROW, 1, HG_PROJECTILE_VSPEED, 10);
set_hitbox_value(AT_DTHROW, 1, HG_PROJECTILE_GRAVITY, 0.50);
//ERROR_NO_SETTER_FOUND(AT_DTHROW, PROJECTILE_LIFETIME, 999999);
