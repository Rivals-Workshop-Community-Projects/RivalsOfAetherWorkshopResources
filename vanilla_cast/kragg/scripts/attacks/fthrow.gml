set_attack_value(AT_FTHROW, AG_CATEGORY, 3);
...
set_window_value(AT_FTHROW, 1, AG_WINDOW_VSPEED_TYPE, 0);
...
set_window_value(AT_FTHROW, 2, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_FTHROW, 2, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_FTHROW, 2, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_FTHROW, 2, AG_WINDOW_SFX, 0);
set_window_value(AT_FTHROW, 2, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_FTHROW, 2, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_FTHROW, 2, AG_WINDOW_INVINCIBILITY, 0);
...
set_window_value(AT_FTHROW, 3, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_FTHROW, 3, AG_WINDOW_VSPEED_TYPE, 0);
...
set_window_value(AT_FTHROW, 3, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_FTHROW, 3, AG_WINDOW_INVINCIBILITY, 0);
//ERROR_NO_SETTER_FOUND(AT_FTHROW, HAS_COOLDOWN, 0);
//ERROR_NO_SETTER_FOUND(AT_FTHROW, COOLDOWN, 0);
set_num_hitboxes(AT_FTHROW, 1);
//ERROR_NO_SETTER_FOUND(AT_FTHROW, NUM_UNIQUE_HITBOXES, 1);
//set_hitbox_value(AT_FTHROW, 1, NUM, 0);
...
set_hitbox_value(AT_FTHROW, 1, HG_LIFETIME, 999999);
set_hitbox_value(AT_FTHROW, 1, HG_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_FTHROW, 1, HG_KNOCKBACK_SCALING, 0.40);
...
set_hitbox_value(AT_FTHROW, 1, HG_HITSTUN_MULTIPLIER, 0.80);
set_hitbox_value(AT_FTHROW, 1, HG_TECHABLE, 0);
...
set_hitbox_value(AT_FTHROW, 1, HG_EXTRA_HITPAUSE, 0);
...
set_hitbox_value(AT_FTHROW, 1, HG_PROJECTILE_GRAVITY, 0.50);
//ERROR_NO_SETTER_FOUND(AT_FTHROW, PROJECTILE_LIFETIME, 999999);
