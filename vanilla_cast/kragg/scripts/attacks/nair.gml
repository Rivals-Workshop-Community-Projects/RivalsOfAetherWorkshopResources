...
set_hitbox_value(AT_NAIR, 1, HG_KNOCKBACK_SCALING, 0.30);
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, 0.25);
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, 0.30);
set_hitbox_value(AT_NAIR, 4, HG_KNOCKBACK_SCALING, 0.40);
...
set_hitbox_value(AT_NAIR, 2, HG_HITPAUSE_SCALING, 0.10);
set_hitbox_value(AT_NAIR, 3, HG_HITPAUSE_SCALING, 0.10);
set_hitbox_value(AT_NAIR, 4, HG_HITPAUSE_SCALING, 0.10);
...
set_hitbox_value(AT_NAIR, 3, HG_VISUAL_EFFECT, 193);
set_hitbox_value(AT_NAIR, 4, HG_VISUAL_EFFECT, 193);
