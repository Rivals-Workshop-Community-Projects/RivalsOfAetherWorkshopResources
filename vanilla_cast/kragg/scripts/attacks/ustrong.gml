...
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, 0.80);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, 155);
set_hitbox_value(AT_USTRONG, 2, HG_VISUAL_EFFECT, 192);
