set_attack_value(AT_NTHROW, AG_CATEGORY, 3);
...
set_window_value(AT_NTHROW, 1, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_NTHROW, 1, AG_WINDOW_VSPEED_TYPE, 0);
...
set_window_value(AT_NTHROW, 1, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_NTHROW, 1, AG_WINDOW_INVINCIBILITY, 0);
...
set_window_value(AT_NTHROW, 2, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_NTHROW, 2, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_NTHROW, 2, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_NTHROW, 2, AG_WINDOW_SFX, 0);
set_window_value(AT_NTHROW, 2, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_NTHROW, 2, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_NTHROW, 2, AG_WINDOW_INVINCIBILITY, 0);
...
set_window_value(AT_NTHROW, 3, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_NTHROW, 3, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_NTHROW, 3, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_NTHROW, 3, AG_WINDOW_SFX, 0);
set_window_value(AT_NTHROW, 3, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_NTHROW, 3, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_NTHROW, 3, AG_WINDOW_INVINCIBILITY, 0);
//ERROR_NO_SETTER_FOUND(AT_NTHROW, HAS_COOLDOWN, 0);
//ERROR_NO_SETTER_FOUND(AT_NTHROW, COOLDOWN, 0);
set_num_hitboxes(AT_NTHROW, 1);
//ERROR_NO_SETTER_FOUND(AT_NTHROW, NUM_UNIQUE_HITBOXES, 1);
//set_hitbox_value(AT_NTHROW, 1, NUM, 0);
...
set_hitbox_value(AT_NTHROW, 1, HG_LIFETIME, 999999);
set_hitbox_value(AT_NTHROW, 1, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_NTHROW, 1, HG_KNOCKBACK_SCALING, 0.40);
...
set_hitbox_value(AT_NTHROW, 1, HG_HITSTUN_MULTIPLIER, 0.80);
...
set_hitbox_value(AT_NTHROW, 1, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_NTHROW, 1, HG_VISUAL_EFFECT, 193);
...
set_hitbox_value(AT_NTHROW, 1, HG_EXTRA_CAMERA_SHAKE, 2);
set_hitbox_value(AT_NTHROW, 1, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_NTHROW, 1, HG_HIT_LOCKOUT, 0);
set_hitbox_value(AT_NTHROW, 1, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_NTHROW, 1, HG_HITBOX_GROUP, 0);
...
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_HSPEED, 5);
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_VSPEED, -9);
set_hitbox_value(AT_NTHROW, 1, HG_PROJECTILE_GRAVITY, 0.50);
//ERROR_NO_SETTER_FOUND(AT_NTHROW, PROJECTILE_LIFETIME, 999999);
