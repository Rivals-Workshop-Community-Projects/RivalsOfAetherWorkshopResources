...
set_window_value(AT_DSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_blow_weak2"));
...
set_hitbox_value(AT_DSTRONG, 2, HG_WIDTH, 65);
set_hitbox_value(AT_DSTRONG, 2, HG_HEIGHT, 30);
set_hitbox_value(AT_DSTRONG, 3, HG_WIDTH, 10);
