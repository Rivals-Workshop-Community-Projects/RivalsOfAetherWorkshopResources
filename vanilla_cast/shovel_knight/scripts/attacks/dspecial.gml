...
set_window_value(AT_DSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_fishing_rod_cast"));
...
set_hitbox_value(AT_DSPECIAL, 3, HG_WINDOW, 12);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_WIDTH, 42);
set_hitbox_value(AT_DSPECIAL, 3, HG_HEIGHT, 42);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HITSTUN_MULTIPLIER, 1.10);
set_hitbox_value(AT_DSPECIAL, 3, HG_HITSTUN_MULTIPLIER, 0.50);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_metal_hit_strong"));
...
//ERROR_NO_SETTER_FOUND(AT_DSPECIAL, 1, PROJECTILE_LIFETIME, 2);
...
//ERROR_NO_SETTER_FOUND(AT_DSPECIAL, 2, PROJECTILE_LIFETIME, 2);
...
//ERROR_NO_SETTER_FOUND(AT_DSPECIAL, 3, PROJECTILE_LIFETIME, 2);
