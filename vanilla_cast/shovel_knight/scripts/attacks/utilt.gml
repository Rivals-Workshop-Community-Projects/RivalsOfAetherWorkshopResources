...
set_hitbox_value(AT_UTILT, 1, HG_HITPAUSE_SCALING, 0.30);
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_buzzsaw_hit"));
...
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_HSPEED, 18);
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_VSPEED, 0);
set_hitbox_value(AT_UTILT, 1, HG_PROJECTILE_GRAVITY, 0);
//ERROR_NO_SETTER_FOUND(AT_UTILT, PROJECTILE_LIFETIME, 21);
