...
set_window_value(AT_DTILT, 1, AG_WINDOW_SFX, asset_get("sfx_shovel_dig"));
...
set_window_value(AT_DTILT, 3, AG_WINDOW_SFX, asset_get("sfx_shovel_swing_med1"));
...
set_hitbox_value(AT_DTILT, 1, HG_KNOCKBACK_SCALING, 0.40);
set_hitbox_value(AT_DTILT, 2, HG_KNOCKBACK_SCALING, 0.40);
...
set_hitbox_value(AT_DTILT, 2, HG_HITSTUN_MULTIPLIER, 1.20);
...
set_hitbox_value(AT_DTILT, 1, HG_HITPAUSE_SCALING, 0.20);
set_hitbox_value(AT_DTILT, 2, HG_HITPAUSE_SCALING, 0.40);
...
set_hitbox_value(AT_DTILT, 1, HG_HIT_SFX, asset_get("sfx_gus_dirt"));
