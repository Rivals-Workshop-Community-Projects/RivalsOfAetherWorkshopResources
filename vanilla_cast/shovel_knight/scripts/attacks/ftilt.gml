...
set_window_value(AT_FTILT, 5, AG_WINDOW_HSPEED, 10);
...
set_window_value(AT_FTILT, 5, AG_WINDOW_SFX, asset_get("sfx_dust_knuckle"));
...
set_window_value(AT_FTILT, 6, AG_WINDOW_VSPEED, 0);
set_window_value(AT_FTILT, 6, AG_WINDOW_HSPEED_TYPE, 2);
set_window_value(AT_FTILT, 6, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_FTILT, 6, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_FTILT, 6, AG_WINDOW_SFX, 0);
set_window_value(AT_FTILT, 6, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_FTILT, 6, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_FTILT, 6, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_FTILT, 7, AG_WINDOW_LENGTH, 8);
set_window_value(AT_FTILT, 7, AG_WINDOW_HSPEED, 0);
set_window_value(AT_FTILT, 7, AG_WINDOW_VSPEED, 0);
set_window_value(AT_FTILT, 7, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_FTILT, 7, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_FTILT, 7, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_FTILT, 7, AG_WINDOW_SFX, 0);
set_window_value(AT_FTILT, 7, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_FTILT, 7, AG_WINDOW_HAS_WHIFFLAG, 4);
set_window_value(AT_FTILT, 7, AG_WINDOW_INVINCIBILITY, 0);
