...
set_window_value(AT_USTRONG, 3, AG_WINDOW_VSPEED, -18);
...
set_hitbox_value(AT_USTRONG, 1, HG_HITBOX_Y, -21);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -34);
