...
set_hitbox_value(AT_UAIR, 3, HG_BASE_KNOCKBACK, 5.50);
...
set_hitbox_value(AT_UAIR, 1, HG_HITBOX_Y, -26);
...
set_hitbox_value(AT_UAIR, 3, HG_HITPAUSE_SCALING, 0.40);
...
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -26);
