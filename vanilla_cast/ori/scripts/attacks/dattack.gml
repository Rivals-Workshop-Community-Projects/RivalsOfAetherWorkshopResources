...
set_hitbox_value(AT_DATTACK, 2, HG_KNOCKBACK_SCALING, 0.20);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITSTUN_MULTIPLIER, 1.20);
...
set_hitbox_value(AT_DATTACK, 2, HG_HITPAUSE_SCALING, 0.70);
set_hitbox_value(AT_DATTACK, 1, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_DATTACK, 2, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_DATTACK, 1, HG_VISUAL_EFFECT, 109);
...
set_hitbox_value(AT_DATTACK, 2, HG_HIT_SFX, asset_get("sfx_ori_energyhit_heavy"));
