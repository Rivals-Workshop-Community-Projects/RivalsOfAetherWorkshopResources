...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_ori_uptilt"));
...
set_window_value(AT_UTILT, 2, AG_WINDOW_SFX, asset_get("sfx_ori_uptilt_single"));
...
set_hitbox_value(AT_UTILT, 3, HG_KNOCKBACK_SCALING, 0.40);
...
set_hitbox_value(AT_UTILT, 3, HG_HITPAUSE_SCALING, 0.50);
...
set_hitbox_value(AT_UTILT, 1, HG_FORCE_FLINCH, 2);
set_hitbox_value(AT_UTILT, 2, HG_FORCE_FLINCH, 2);
