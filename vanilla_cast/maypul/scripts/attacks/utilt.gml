...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_may_root"));
...
set_hitbox_value(AT_UTILT, 2, HG_KNOCKBACK_SCALING, 0.50);
...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_X, -39);
...
set_hitbox_value(AT_UTILT, 1, HG_HITPAUSE_SCALING, 0.50);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, 17);
