...
set_window_value(AT_UAIR, 5, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_UAIR, 5, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_UAIR, 5, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_UAIR, 5, AG_WINDOW_SFX, 0);
set_window_value(AT_UAIR, 5, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_UAIR, 5, AG_WINDOW_HAS_WHIFFLAG, 3);
set_window_value(AT_UAIR, 5, AG_WINDOW_INVINCIBILITY, 0);
...
//ERROR_NO_SETTER_FOUND(AT_UAIR, NUM_UNIQUE_HITBOXES, 4);
//set_hitbox_value(AT_UAIR, 1, NUM, 2);
...
set_hitbox_value(AT_UAIR, 6, HG_BASE_KNOCKBACK, 7);
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_UAIR, 2, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_UAIR, 3, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_UAIR, 4, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_UAIR, 5, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_UAIR, 1, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_UAIR, 2, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_UAIR, 3, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_UAIR, 4, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_UAIR, 5, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_UAIR, 6, HG_KNOCKBACK_SCALING, 0.70);
set_hitbox_value(AT_UAIR, 6, HG_KNOCKBACK_SCALING, 0.70);
...
set_hitbox_value(AT_UAIR, 5, HG_WIDTH, 70);
...
set_hitbox_value(AT_UAIR, 6, HG_EFFECT, 0);
set_hitbox_value(AT_UAIR, 1, HG_SDI_MULTIPLIER, 1.20);
set_hitbox_value(AT_UAIR, 2, HG_SDI_MULTIPLIER, 1.20);
set_hitbox_value(AT_UAIR, 3, HG_SDI_MULTIPLIER, 1.20);
set_hitbox_value(AT_UAIR, 4, HG_SDI_MULTIPLIER, 1.20);
set_hitbox_value(AT_UAIR, 5, HG_SDI_MULTIPLIER, 1.20);
set_hitbox_value(AT_UAIR, 1, HG_SDI_MULTIPLIER, 1.20);
set_hitbox_value(AT_UAIR, 2, HG_SDI_MULTIPLIER, 1.20);
set_hitbox_value(AT_UAIR, 3, HG_SDI_MULTIPLIER, 1.20);
set_hitbox_value(AT_UAIR, 4, HG_SDI_MULTIPLIER, 1.20);
...
set_hitbox_value(AT_UAIR, 3, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_UAIR, 4, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_UAIR, 5, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_UAIR, 1, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_UAIR, 2, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_UAIR, 3, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_UAIR, 4, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_UAIR, 5, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_UAIR, 6, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_UAIR, 6, HG_HITSTUN_MULTIPLIER, 0);
...
set_hitbox_value(AT_UAIR, 4, HG_TECHABLE, 0);
set_hitbox_value(AT_UAIR, 5, HG_TECHABLE, 0);
set_hitbox_value(AT_UAIR, 6, HG_TECHABLE, 0);
set_hitbox_value(AT_UAIR, 6, HG_TECHABLE, 0);
...
set_hitbox_value(AT_UAIR, 4, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_UAIR, 5, HG_HITPAUSE_SCALING, 0);
set_hitbox_value(AT_UAIR, 6, HG_HITPAUSE_SCALING, 0.80);
set_hitbox_value(AT_UAIR, 6, HG_HITPAUSE_SCALING, 0.80);
...
set_hitbox_value(AT_UAIR, 5, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_UAIR, 1, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_UAIR, 2, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_UAIR, 3, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_UAIR, 4, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_UAIR, 5, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_UAIR, 6, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_UAIR, 6, HG_EXTRA_HITPAUSE, 0);
...
set_hitbox_value(AT_UAIR, 4, HG_EXTRA_CAMERA_SHAKE, 0);
set_hitbox_value(AT_UAIR, 5, HG_EXTRA_CAMERA_SHAKE, 0);
set_hitbox_value(AT_UAIR, 1, HG_EXTRA_CAMERA_SHAKE, 0);
set_hitbox_value(AT_UAIR, 2, HG_EXTRA_CAMERA_SHAKE, 0);
set_hitbox_value(AT_UAIR, 3, HG_EXTRA_CAMERA_SHAKE, 0);
set_hitbox_value(AT_UAIR, 4, HG_EXTRA_CAMERA_SHAKE, 0);
set_hitbox_value(AT_UAIR, 5, HG_EXTRA_CAMERA_SHAKE, 0);
set_hitbox_value(AT_UAIR, 6, HG_EXTRA_CAMERA_SHAKE, 0);
set_hitbox_value(AT_UAIR, 6, HG_EXTRA_CAMERA_SHAKE, 0);
...
set_hitbox_value(AT_UAIR, 5, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_UAIR, 1, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_UAIR, 2, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_UAIR, 3, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_UAIR, 4, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_UAIR, 5, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_UAIR, 6, HG_IGNORES_PROJECTILES, 1);
set_hitbox_value(AT_UAIR, 6, HG_IGNORES_PROJECTILES, 1);
...
set_hitbox_value(AT_UAIR, 3, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_UAIR, 4, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_UAIR, 5, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_UAIR, 1, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_UAIR, 2, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_UAIR, 3, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_UAIR, 4, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_UAIR, 5, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_UAIR, 6, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_UAIR, 6, HG_EXTENDED_PARRY_STUN, 0);
...
set_hitbox_value(AT_UAIR, 5, HG_FORCE_FLINCH, 0);
set_hitbox_value(AT_UAIR, 1, HG_FORCE_FLINCH, 0);
set_hitbox_value(AT_UAIR, 2, HG_FORCE_FLINCH, 0);
set_hitbox_value(AT_UAIR, 3, HG_FORCE_FLINCH, 0);
set_hitbox_value(AT_UAIR, 4, HG_FORCE_FLINCH, 0);
