...
//ERROR_NO_SETTER_FOUND(AT_NAIR, AUTOCANCEL_FRAME, 2);
//ERROR_NO_SETTER_FOUND(AT_NAIR, LANDING_LAG, 4);
set_num_hitboxes(AT_NAIR, 3);
//ERROR_NO_SETTER_FOUND(AT_NAIR, NUM_UNIQUE_HITBOXES, 3);
...
set_hitbox_value(AT_NAIR, 1, HG_KNOCKBACK_SCALING, 0.50);
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, 0.30);
...
set_hitbox_value(AT_NAIR, 3, HG_HITBOX_X, -48);
...
set_hitbox_value(AT_NAIR, 2, HG_HITPAUSE_SCALING, 0.20);
