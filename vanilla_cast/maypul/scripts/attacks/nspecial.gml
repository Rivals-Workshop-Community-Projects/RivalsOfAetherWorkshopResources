...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITSTUN_MULTIPLIER, 0.40);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, 18);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_GRAVITY, 0.30);
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, PROJECTILE_LIFETIME, 9999);
