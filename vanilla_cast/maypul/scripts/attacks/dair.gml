...
//ERROR_NO_SETTER_FOUND(AT_DAIR, AUTOCANCEL_FRAME, 2);
...
set_hitbox_value(AT_DAIR, 1, HG_KNOCKBACK_SCALING, 0.40);
...
//ERROR_NO_SETTER_FOUND(AT_DAIR, PROJECTILE_LIFETIME, 999999);
