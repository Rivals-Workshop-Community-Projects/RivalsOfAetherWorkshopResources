...
set_window_value(AT_DATTACK, 5, AG_WINDOW_LENGTH, 13);
...
set_window_value(AT_DATTACK, 5, AG_WINDOW_HAS_WHIFFLAG, 7);
...
set_hitbox_value(AT_DATTACK, 1, HG_HITPAUSE_SCALING, 0.10);
