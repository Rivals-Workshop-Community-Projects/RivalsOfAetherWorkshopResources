...
set_hitbox_value(AT_DSTRONG, 3, HG_KNOCKBACK_SCALING, 1.10);
set_hitbox_value(AT_DSTRONG, 4, HG_KNOCKBACK_SCALING, 1.10);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HITBOX_X, -43);
set_hitbox_value(AT_DSTRONG, 4, HG_HITBOX_Y, -6);
set_hitbox_value(AT_DSTRONG, 1, HG_EFFECT, 4);
set_hitbox_value(AT_DSTRONG, 2, HG_EFFECT, 4);
set_hitbox_value(AT_DSTRONG, 3, HG_EFFECT, 4);
set_hitbox_value(AT_DSTRONG, 4, HG_EFFECT, 4);
...
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT, 198);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT, 198);
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT, 198);
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT, 198);
set_hitbox_value(AT_DSTRONG, 1, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_DSTRONG, 2, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_DSTRONG, 3, HG_VISUAL_EFFECT_X_OFFSET, 20);
set_hitbox_value(AT_DSTRONG, 4, HG_VISUAL_EFFECT_X_OFFSET, 20);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HIT_SFX, asset_get("sfx_may_whip1"));
