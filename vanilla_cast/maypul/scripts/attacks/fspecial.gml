...
ERROR_NO_SETTER_FOUND(AT_FSPECIAL, BOOST_SPEED_GROUND, 20);
ERROR_NO_SETTER_FOUND(AT_FSPECIAL, BOOST_SPEED_AIR, 12);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITSTUN_MULTIPLIER, 0.80);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, 18);
