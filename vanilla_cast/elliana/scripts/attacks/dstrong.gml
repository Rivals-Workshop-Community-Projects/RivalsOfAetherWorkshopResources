...
//ERROR_NO_SETTER_FOUND(AT_DSTRONG, NUM_UNIQUE_HITBOXES, 2);
...
set_hitbox_value(AT_DSTRONG, 1, HG_KNOCKBACK_SCALING, 0.20);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HIT_SFX, asset_get("sfx_ell_steam_hit"));
set_hitbox_value(AT_DSTRONG, 2, HG_HIT_SFX, asset_get("sfx_ori_charged_flame_hit"));
