...
//ERROR_NO_SETTER_FOUND(AT_DAIR, HAS_WHIFF_LANDING, 1);
...
//set_hitbox_value(AT_DAIR, 1, NUM, 1);
...
set_hitbox_value(AT_DAIR, 1, HG_WIDTH, 94);
set_hitbox_value(AT_DAIR, 2, HG_WIDTH, 94);
...
set_hitbox_value(AT_DAIR, 1, HG_HITPAUSE_SCALING, 0.20);
set_hitbox_value(AT_DAIR, 2, HG_HITPAUSE_SCALING, 0.20);
set_hitbox_value(AT_DAIR, 3, HG_HITPAUSE_SCALING, 0.20);
