...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_ell_dtilt2"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_ell_fist_fire"));
...
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, COOLDOWN, 20);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_LIFETIME, 9000);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_KNOCKBACK_SCALING, 0.80);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITBOX_Y, -106);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_HITPAUSE_SCALING, 0.50);
...
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, 1, PROJECTILE_LIFETIME, 16);
...
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, 2, PROJECTILE_LIFETIME, 16);
