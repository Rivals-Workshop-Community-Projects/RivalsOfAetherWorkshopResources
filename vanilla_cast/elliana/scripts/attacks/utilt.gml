...
set_window_value(AT_UTILT, 1, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_fire"));
...
set_window_value(AT_UTILT, 2, AG_WINDOW_LENGTH, 60);
...
set_window_value(AT_UTILT, 3, AG_WINDOW_HAS_WHIFFLAG, 0);
...
set_window_value(AT_UTILT, 4, AG_WINDOW_HSPEED_TYPE, 0);
...
set_window_value(AT_UTILT, 4, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_UTILT, 5, AG_WINDOW_LENGTH, 18);
set_window_value(AT_UTILT, 5, AG_WINDOW_HSPEED, 0);
set_window_value(AT_UTILT, 5, AG_WINDOW_VSPEED, 0);
set_window_value(AT_UTILT, 5, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_UTILT, 5, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_UTILT, 5, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_UTILT, 5, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_cannon"));
set_window_value(AT_UTILT, 5, AG_WINDOW_SFX_FRAME, 10);
set_window_value(AT_UTILT, 5, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_UTILT, 5, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_UTILT, 6, AG_WINDOW_LENGTH, 10);
set_window_value(AT_UTILT, 6, AG_WINDOW_HSPEED, 0);
set_window_value(AT_UTILT, 6, AG_WINDOW_VSPEED, 0);
set_window_value(AT_UTILT, 6, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_UTILT, 6, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_UTILT, 6, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_UTILT, 6, AG_WINDOW_SFX, 0);
set_window_value(AT_UTILT, 6, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_UTILT, 6, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_UTILT, 6, AG_WINDOW_INVINCIBILITY, 0);
//ERROR_NO_SETTER_FOUND(AT_UTILT, HAS_COOLDOWN, 0);
//ERROR_NO_SETTER_FOUND(AT_UTILT, COOLDOWN, 0);
set_num_hitboxes(AT_UTILT, 2);
//ERROR_NO_SETTER_FOUND(AT_UTILT, NUM_UNIQUE_HITBOXES, 2);
//set_hitbox_value(AT_UTILT, 1, NUM, 0);
set_hitbox_value(AT_UTILT, 1, HG_PARENT_HITBOX, 1);
set_hitbox_value(AT_UTILT, 2, HG_PARENT_HITBOX, 2);
set_hitbox_value(AT_UTILT, 1, HG_WINDOW, 6);
...
set_hitbox_value(AT_UTILT, 2, HG_LIFETIME, 22);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 18);
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_SFX, asset_get("sfx_ori_charged_flame_hit"));
set_hitbox_value(AT_UTILT, 2, HG_HIT_SFX, asset_get("sfx_ell_utilt_hit"));
...
set_hitbox_value(AT_UTILT, 1, HG_HIT_LOCKOUT, 30);
