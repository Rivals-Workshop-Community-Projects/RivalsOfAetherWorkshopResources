...
set_window_value(AT_DATTACK, 1, AG_WINDOW_HSPEED, 4.50);
...
set_window_value(AT_DATTACK, 1, AG_WINDOW_SFX, asset_get("sfx_ell_utilt_retract"));
...
set_window_value(AT_DATTACK, 2, AG_WINDOW_HSPEED, 4.50);
...
set_window_value(AT_DATTACK, 3, AG_WINDOW_HSPEED, 4.50);
...
set_hitbox_value(AT_DATTACK, 1, HG_WIDTH, 34);
...
set_hitbox_value(AT_DATTACK, 1, HG_HITPAUSE_SCALING, 0.30);
