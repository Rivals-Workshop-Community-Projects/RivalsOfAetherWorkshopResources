...
set_window_value(AT_NAIR, 3, AG_WINDOW_HAS_WHIFFLAG, 7);
...
//ERROR_NO_SETTER_FOUND(AT_NAIR, HAS_WHIFF_LANDING, 0);
//ERROR_NO_SETTER_FOUND(AT_NAIR, AUTOCANCEL_FRAME, 5);
...
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, 0.40);
...
set_hitbox_value(AT_NAIR, 2, HG_HITBOX_X, 74);
...
set_hitbox_value(AT_NAIR, 1, HG_HIT_SFX, asset_get("sfx_metal_hit_strong"));
...
set_hitbox_value(AT_NAIR, 3, HG_HIT_LOCKOUT, 4);
