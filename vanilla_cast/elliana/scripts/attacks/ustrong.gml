...
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 0.30);
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, 1.20);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, 144);
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, asset_get("sfx_ori_charged_flame_hit"));
