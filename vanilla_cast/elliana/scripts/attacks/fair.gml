...
//set_hitbox_value(AT_FAIR, 1, NUM, 1);
...
set_hitbox_value(AT_FAIR, 2, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_FAIR, 3, HG_KNOCKBACK_SCALING, 0.45);
set_hitbox_value(AT_FAIR, 1, HG_ANGLE, 82);
set_hitbox_value(AT_FAIR, 2, HG_ANGLE, 82);
...
set_hitbox_value(AT_FAIR, 2, HG_HITPAUSE_SCALING, 0.10);
...
set_hitbox_value(AT_FAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 8);
...
set_hitbox_value(AT_FAIR, 2, HG_FORCE_FLINCH, 1);
