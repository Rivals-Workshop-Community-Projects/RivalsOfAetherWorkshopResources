...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_HAS_WHIFFLAG, 9);
...
set_hitbox_value(AT_FSTRONG, 1, HG_KNOCKBACK_SCALING, 0.35);
...
set_hitbox_value(AT_FSTRONG, 1, HG_VISUAL_EFFECT, 144);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, asset_get("sfx_ell_steam_hit"));
