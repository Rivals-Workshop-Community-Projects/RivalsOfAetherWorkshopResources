...
set_window_value(AT_FTILT, 1, AG_WINDOW_SFX, asset_get("sfx_ell_drill_stab"));
...
set_window_value(AT_FTILT, 3, AG_WINDOW_SFX, asset_get("sfx_ell_drill_stab"));
...
set_window_value(AT_FTILT, 5, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_FTILT, 5, AG_WINDOW_SFX, 0);
set_window_value(AT_FTILT, 5, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_FTILT, 5, AG_WINDOW_HAS_WHIFFLAG, 7);
set_window_value(AT_FTILT, 5, AG_WINDOW_INVINCIBILITY, 0);
...
set_hitbox_value(AT_FTILT, 3, HG_KNOCKBACK_SCALING, 0.45);
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_X, 63);
...
set_hitbox_value(AT_FTILT, 3, HG_HITPAUSE_SCALING, 0.40);
...
set_hitbox_value(AT_FTILT, 3, HG_VISUAL_EFFECT_X_OFFSET, 25);
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_GROUP, 0);
