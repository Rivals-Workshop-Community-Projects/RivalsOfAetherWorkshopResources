...
set_hitbox_value(AT_DTILT, 1, HG_BASE_KNOCKBACK, 3.50);
set_hitbox_value(AT_DTILT, 2, HG_BASE_KNOCKBACK, 6);
set_hitbox_value(AT_DTILT, 1, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_DTILT, 2, HG_KNOCKBACK_SCALING, 0.70);
...
set_hitbox_value(AT_DTILT, 2, HG_HITPAUSE_SCALING, 0.60);
