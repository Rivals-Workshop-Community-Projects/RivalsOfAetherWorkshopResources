...
set_window_value(AT_FSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_orcane_fspecial"));
...
set_window_value(AT_FSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_orcane_fspecial"));
...
set_hitbox_value(AT_FSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.40);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITPAUSE_SCALING, 0.10);
set_hitbox_value(AT_FSPECIAL, 1, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, 149);
