...
//ERROR_NO_SETTER_FOUND(AT_DAIR, HAS_WHIFF_LANDING, 2);
//ERROR_NO_SETTER_FOUND(AT_DAIR, AUTOCANCEL_FRAME, 20);
...
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, 7);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, 20);
set_hitbox_value(AT_DAIR, 1, HG_HIT_SFX, asset_get("sfx_waterhit_weak"));
