...
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, COOLDOWN, 60);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_VISUAL_EFFECT, 5);
...
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_VSPEED, -5.50);
set_hitbox_value(AT_NSPECIAL, 1, HG_PROJECTILE_GRAVITY, 0.60);
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, PROJECTILE_LIFETIME, 9000);
