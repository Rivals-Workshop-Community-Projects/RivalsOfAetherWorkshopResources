...
//ERROR_NO_SETTER_FOUND(AT_USTRONG, NUM_UNIQUE_HITBOXES, 1);
...
ERROR_NO_SETTER_FOUND(AT_USTRONG, 1, FINAL_BASE_KNOCKBACK, 8);
set_hitbox_value(AT_USTRONG, 1, HG_KNOCKBACK_SCALING, 1.30);
