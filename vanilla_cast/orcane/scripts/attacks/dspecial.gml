...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_bubblepop"));
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HITSTUN_MULTIPLIER, 0.50);
set_hitbox_value(AT_DSPECIAL, 1, HG_TECHABLE, 0);
set_hitbox_value(AT_DSPECIAL, 1, HG_PRIORITY, 1);
set_hitbox_value(AT_DSPECIAL, 1, HG_BASE_HITPAUSE, 6);
set_hitbox_value(AT_DSPECIAL, 1, HG_HITPAUSE_SCALING, 0.10);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_PROJECTILE_GRAVITY, 0.60);
//ERROR_NO_SETTER_FOUND(AT_DSPECIAL, PROJECTILE_LIFETIME, 9000);
