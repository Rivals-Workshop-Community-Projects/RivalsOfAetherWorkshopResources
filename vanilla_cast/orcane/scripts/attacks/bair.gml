...
set_window_value(AT_BAIR, 1, AG_WINDOW_SFX, asset_get("sfx_swish_weak"));
...
//ERROR_NO_SETTER_FOUND(AT_BAIR, HAS_WHIFF_LANDING, 5);
...
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT, 5);
...
set_hitbox_value(AT_BAIR, 1, HG_HIT_SFX, asset_get("sfx_waterhit_weak"));
