...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_ice_dspecial_form"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_LENGTH, 9000);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_HSPEED, 0);
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_VSPEED, 22);
...
ERROR_NO_SETTER_FOUND(AT_DSPECIAL, 3, FINAL_BASE_KNOCKBACK, 2);
set_hitbox_value(AT_DSPECIAL, 1, HG_KNOCKBACK_SCALING, 1.20);
set_hitbox_value(AT_DSPECIAL, 2, HG_KNOCKBACK_SCALING, 0.90);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HITPAUSE_SCALING, 0.75);
set_hitbox_value(AT_DSPECIAL, 3, HG_HITPAUSE_SCALING, 0.10);
...
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_icehit_heavy2"));
set_hitbox_value(AT_DSPECIAL, 3, HG_HIT_SFX, asset_get("sfx_icehit_medium1"));
set_hitbox_value(AT_DSPECIAL, 1, HG_EXTRA_CAMERA_SHAKE, 2);
set_hitbox_value(AT_DSPECIAL, 2, HG_EXTRA_CAMERA_SHAKE, 4);
