...
set_window_value(AT_DSTRONG, 4, AG_WINDOW_HAS_WHIFFLAG, 13);
...
set_hitbox_value(AT_DSTRONG, 4, HG_KNOCKBACK_SCALING, 0.30);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITBOX_Y, -80);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HITSTUN_MULTIPLIER, 0.20);
...
set_hitbox_value(AT_DSTRONG, 4, HG_HITPAUSE_SCALING, 0.10);
