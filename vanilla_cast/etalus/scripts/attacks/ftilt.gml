...
set_window_value(AT_FTILT, 2, AG_WINDOW_SFX, asset_get("sfx_ice_ftilt"));
...
set_hitbox_value(AT_FTILT, 1, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_FTILT, 2, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_FTILT, 3, HG_KNOCKBACK_SCALING, 0.30);
...
set_hitbox_value(AT_FTILT, 1, HG_HITPAUSE_SCALING, 0.10);
set_hitbox_value(AT_FTILT, 2, HG_HITPAUSE_SCALING, 0.10);
...
set_hitbox_value(AT_FTILT, 1, HG_VISUAL_EFFECT, 29);
set_hitbox_value(AT_FTILT, 2, HG_VISUAL_EFFECT, 29);
set_hitbox_value(AT_FTILT, 3, HG_VISUAL_EFFECT, 29);
...
set_hitbox_value(AT_FTILT, 3, HG_HIT_SFX, asset_get("sfx_icehit_weak2"));
