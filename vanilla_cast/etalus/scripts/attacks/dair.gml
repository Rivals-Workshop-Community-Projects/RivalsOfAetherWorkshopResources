...
//ERROR_NO_SETTER_FOUND(AT_DAIR, HAS_WHIFF_LANDING, 8);
//ERROR_NO_SETTER_FOUND(AT_DAIR, AUTOCANCEL_FRAME, 23);
...
set_hitbox_value(AT_DAIR, 1, HG_KNOCKBACK_SCALING, 0.20);
set_hitbox_value(AT_DAIR, 2, HG_KNOCKBACK_SCALING, 0.20);
set_hitbox_value(AT_DAIR, 3, HG_KNOCKBACK_SCALING, 0.50);
...
set_hitbox_value(AT_DAIR, 2, HG_HITPAUSE_SCALING, 0.40);
set_hitbox_value(AT_DAIR, 3, HG_HITPAUSE_SCALING, 0.40);
