...
ERROR_NO_SETTER_FOUND(AT_NSPECIAL, MAX_FALL_SPEED, 6);
ERROR_NO_SETTER_FOUND(AT_NSPECIAL, GRAVITY_CHANGE, 0.30);
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_LENGTH, 63);
...
set_window_value(AT_NSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_ice_nspecial_hit_ground"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_KNOCKBACK_SCALING, 1.30);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_VISUAL_EFFECT, 158);
