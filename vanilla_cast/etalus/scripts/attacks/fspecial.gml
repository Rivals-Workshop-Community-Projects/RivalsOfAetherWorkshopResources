...
//ERROR_NO_SETTER_FOUND(AT_FSPECIAL, COOLDOWN, 75);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_LIFETIME, 999999);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_HITBOX_Y, -1900);
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_X, 0);
set_hitbox_value(AT_FSPECIAL, 2, HG_HITBOX_Y, -1900);
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_X, 60);
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_Y, -1900);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_VISUAL_EFFECT, 29);
...
set_hitbox_value(AT_FSPECIAL, 3, HG_HITBOX_GROUP, 0);
...
//ERROR_NO_SETTER_FOUND(AT_FSPECIAL, 1, PROJECTILE_LIFETIME, 999999);
...
//ERROR_NO_SETTER_FOUND(AT_FSPECIAL, 2, PROJECTILE_LIFETIME, 0);
...
//ERROR_NO_SETTER_FOUND(AT_FSPECIAL, 3, PROJECTILE_LIFETIME, 0);
