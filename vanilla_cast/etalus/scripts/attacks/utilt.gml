...
set_window_value(AT_UTILT, 2, AG_WINDOW_INVINCIBILITY, 5);
...
set_hitbox_value(AT_UTILT, 2, HG_HITBOX_Y, -117);
...
set_hitbox_value(AT_UTILT, 1, HG_HITSTUN_MULTIPLIER, 1.20);
set_hitbox_value(AT_UTILT, 2, HG_HITSTUN_MULTIPLIER, 1.20);
