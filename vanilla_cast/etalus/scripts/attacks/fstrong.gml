...
set_window_value(AT_FSTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_ice_shatter"));
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_SFX, asset_get("sfx_ice_shatter"));
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITSTUN_MULTIPLIER, 0.50);
