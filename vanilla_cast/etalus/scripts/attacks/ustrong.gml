...
set_window_value(AT_USTRONG, 3, AG_WINDOW_SFX, asset_get("sfx_ice_shatter"));
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -134);
...
set_hitbox_value(AT_USTRONG, 1, HG_HITSTUN_MULTIPLIER, 0.80);
set_hitbox_value(AT_USTRONG, 2, HG_HITSTUN_MULTIPLIER, 0.80);
...
set_hitbox_value(AT_USTRONG, 3, HG_HIT_SFX, asset_get("sfx_icehit_heavy1"));
