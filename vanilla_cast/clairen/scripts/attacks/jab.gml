...
set_hitbox_value(AT_JAB, 1, HG_KNOCKBACK_SCALING, 0.20);
set_hitbox_value(AT_JAB, 2, HG_KNOCKBACK_SCALING, 0.30);
...
set_hitbox_value(AT_JAB, 2, HG_HITBOX_X, 98);
...
set_hitbox_value(AT_JAB, 1, HG_HITSTUN_MULTIPLIER, 0.60);
...
set_hitbox_value(AT_JAB, 2, HG_HITPAUSE_SCALING, 0.10);
set_hitbox_value(AT_JAB, 1, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_JAB, 2, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_JAB, 1, HG_VISUAL_EFFECT, 124);
set_hitbox_value(AT_JAB, 2, HG_VISUAL_EFFECT, 126);
...
set_hitbox_value(AT_JAB, 2, HG_HIT_SFX, asset_get("sfx_clairen_tip_weak"));
