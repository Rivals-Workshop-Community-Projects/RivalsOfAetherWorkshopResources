...
set_hitbox_value(AT_DTILT, 2, HG_KNOCKBACK_SCALING, 0.35);
set_hitbox_value(AT_DTILT, 1, HG_ANGLE, 361);
set_hitbox_value(AT_DTILT, 2, HG_ANGLE, 32);
...
set_hitbox_value(AT_DTILT, 2, HG_HEIGHT, 22);
...
set_hitbox_value(AT_DTILT, 2, HG_HITPAUSE_SCALING, 0.30);
set_hitbox_value(AT_DTILT, 1, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_DTILT, 2, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT, 124);
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT, 125);
set_hitbox_value(AT_DTILT, 1, HG_VISUAL_EFFECT_X_OFFSET, 30);
set_hitbox_value(AT_DTILT, 2, HG_VISUAL_EFFECT_X_OFFSET, 6);
...
set_hitbox_value(AT_DTILT, 2, HG_HIT_SFX, asset_get("sfx_clairen_tip_med"));
