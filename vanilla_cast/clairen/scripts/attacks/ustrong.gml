...
set_hitbox_value(AT_USTRONG, 2, HG_KNOCKBACK_SCALING, 0.50);
...
set_hitbox_value(AT_USTRONG, 3, HG_HITBOX_Y, -129);
set_hitbox_value(AT_USTRONG, 1, HG_EFFECT, 0);
set_hitbox_value(AT_USTRONG, 2, HG_EFFECT, 0);
set_hitbox_value(AT_USTRONG, 3, HG_EFFECT, 11);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT, 128);
...
set_hitbox_value(AT_USTRONG, 1, HG_VISUAL_EFFECT_Y_OFFSET, -22);
