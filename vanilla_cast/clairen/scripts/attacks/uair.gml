...
//ERROR_NO_SETTER_FOUND(AT_UAIR, NUM_UNIQUE_HITBOXES, 3);
...
set_hitbox_value(AT_UAIR, 2, HG_KNOCKBACK_SCALING, 0.70);
set_hitbox_value(AT_UAIR, 3, HG_KNOCKBACK_SCALING, 0.30);
...
set_hitbox_value(AT_UAIR, 2, HG_HEIGHT, 138);
...
set_hitbox_value(AT_UAIR, 2, HG_HITPAUSE_SCALING, 0.80);
...
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT, 128);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT, 126);
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT, 128);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, 4);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 0);
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT_X_OFFSET, 4);
set_hitbox_value(AT_UAIR, 1, HG_VISUAL_EFFECT_Y_OFFSET, -45);
set_hitbox_value(AT_UAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, -60);
set_hitbox_value(AT_UAIR, 3, HG_VISUAL_EFFECT_Y_OFFSET, -45);
set_hitbox_value(AT_UAIR, 1, HG_HIT_SFX, asset_get("sfx_clairen_hit_med"));
set_hitbox_value(AT_UAIR, 2, HG_HIT_SFX, asset_get("sfx_clairen_tip_med"));
set_hitbox_value(AT_UAIR, 3, HG_HIT_SFX, asset_get("sfx_clairen_hit_weak"));
