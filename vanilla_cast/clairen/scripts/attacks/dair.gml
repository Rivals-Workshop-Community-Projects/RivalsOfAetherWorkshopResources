...
//ERROR_NO_SETTER_FOUND(AT_DAIR, HAS_WHIFF_LANDING, 12);
//ERROR_NO_SETTER_FOUND(AT_DAIR, AUTOCANCEL_FRAME, 11);
//ERROR_NO_SETTER_FOUND(AT_DAIR, LANDING_LAG, 10);
set_num_hitboxes(AT_DAIR, 4);
//ERROR_NO_SETTER_FOUND(AT_DAIR, NUM_UNIQUE_HITBOXES, 4);
...
set_hitbox_value(AT_DAIR, 4, HG_KNOCKBACK_SCALING, 0.60);
...
set_hitbox_value(AT_DAIR, 1, HG_HEIGHT, 108);
...
set_hitbox_value(AT_DAIR, 4, HG_HEIGHT, 74);
...
set_hitbox_value(AT_DAIR, 3, HG_HITSTUN_MULTIPLIER, 0);
set_hitbox_value(AT_DAIR, 4, HG_HITSTUN_MULTIPLIER, 0);
...
set_hitbox_value(AT_DAIR, 2, HG_HITPAUSE_SCALING, 0.80);
set_hitbox_value(AT_DAIR, 3, HG_HITPAUSE_SCALING, 0.50);
set_hitbox_value(AT_DAIR, 4, HG_HITPAUSE_SCALING, 0.80);
...
set_hitbox_value(AT_DAIR, 4, HG_EXTRA_HITPAUSE, 0);
set_hitbox_value(AT_DAIR, 1, HG_VISUAL_EFFECT, 124);
set_hitbox_value(AT_DAIR, 2, HG_VISUAL_EFFECT, 127);
set_hitbox_value(AT_DAIR, 3, HG_VISUAL_EFFECT, 128);
set_hitbox_value(AT_DAIR, 4, HG_VISUAL_EFFECT, 127);
...
set_hitbox_value(AT_DAIR, 4, HG_VISUAL_EFFECT_X_OFFSET, 22);
...
set_hitbox_value(AT_DAIR, 4, HG_VISUAL_EFFECT_Y_OFFSET, 13);
...
set_hitbox_value(AT_DAIR, 3, HG_HIT_SFX, asset_get("sfx_clairen_hit_weak"));
set_hitbox_value(AT_DAIR, 4, HG_HIT_SFX, asset_get("sfx_clairen_tip_strong"));
...
set_hitbox_value(AT_DAIR, 4, HG_EXTENDED_PARRY_STUN, 0);
