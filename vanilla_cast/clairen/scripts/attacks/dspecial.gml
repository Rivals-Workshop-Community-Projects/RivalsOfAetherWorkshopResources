...
ERROR_NO_SETTER_FOUND(AT_DSPECIAL, PLASMA_FIELD_LIFETIME, 600);
...
set_window_value(AT_DSPECIAL, 2, AG_WINDOW_SFX, asset_get("sfx_clairen_dspecial_counter_active"));
...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_forsburn_consume_fail"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_clairen_dspecial_counter_success"));
...
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_SFX, 0);
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_INVINCIBILITY, 0);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_KNOCKBACK_SCALING, 0.30);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_WIDTH, 208);
set_hitbox_value(AT_DSPECIAL, 1, HG_HEIGHT, 208);
set_hitbox_value(AT_DSPECIAL, 2, HG_WIDTH, 272);
set_hitbox_value(AT_DSPECIAL, 2, HG_HEIGHT, 272);
set_hitbox_value(AT_DSPECIAL, 3, HG_WIDTH, 360);
set_hitbox_value(AT_DSPECIAL, 3, HG_HEIGHT, 360);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITSTUN_MULTIPLIER, 0.90);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITPAUSE_SCALING, 0.20);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_VISUAL_EFFECT, 123);
set_hitbox_value(AT_DSPECIAL, 2, HG_VISUAL_EFFECT, 123);
set_hitbox_value(AT_DSPECIAL, 3, HG_VISUAL_EFFECT, 123);
...
set_hitbox_value(AT_DSPECIAL, 1, HG_HIT_SFX, asset_get("sfx_clairen_hit_weak"));
set_hitbox_value(AT_DSPECIAL, 2, HG_HIT_SFX, asset_get("sfx_clairen_hit_weak"));
set_hitbox_value(AT_DSPECIAL, 3, HG_HIT_SFX, asset_get("sfx_clairen_hit_weak"));
...
set_hitbox_value(AT_DSPECIAL, 2, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_DSPECIAL, 3, HG_EXTENDED_PARRY_STUN, 0);
