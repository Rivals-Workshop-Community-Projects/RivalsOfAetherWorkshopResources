...
//ERROR_NO_SETTER_FOUND(AT_BAIR, LANDING_LAG, 8);
...
set_hitbox_value(AT_BAIR, 2, HG_KNOCKBACK_SCALING, 0.80);
...
set_hitbox_value(AT_BAIR, 2, HG_HEIGHT, 122);
...
set_hitbox_value(AT_BAIR, 1, HG_HITPAUSE_SCALING, 0.20);
set_hitbox_value(AT_BAIR, 2, HG_HITPAUSE_SCALING, 0.80);
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT, 126);
set_hitbox_value(AT_BAIR, 1, HG_VISUAL_EFFECT_X_OFFSET, -32);
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, -40);
...
set_hitbox_value(AT_BAIR, 2, HG_HIT_SFX, asset_get("sfx_clairen_tip_med"));
