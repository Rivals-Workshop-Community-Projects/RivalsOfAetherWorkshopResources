...
//set_hitbox_value(AT_UTILT, 1, NUM, 1);
...
set_hitbox_value(AT_UTILT, 1, HG_VISUAL_EFFECT, 14);
set_hitbox_value(AT_UTILT, 2, HG_VISUAL_EFFECT, 14);
set_hitbox_value(AT_UTILT, 3, HG_VISUAL_EFFECT, 13);
