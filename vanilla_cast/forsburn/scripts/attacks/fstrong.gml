...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_forsburn_cape_swipe"));
...
set_window_value(AT_FSTRONG, 4, AG_WINDOW_CANCEL_FRAME, 9);
...
set_window_value(AT_FSTRONG, 6, AG_WINDOW_SFX_FRAME, 1);
...
set_window_value(AT_FSTRONG, 7, AG_WINDOW_HAS_WHIFFLAG, 12);
...
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, 0.80);
...
set_hitbox_value(AT_FSTRONG, 1, HG_WIDTH, 156);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HIT_SFX, asset_get("sfx_forsburn_cape_hit"));
