...
//ERROR_NO_SETTER_FOUND(AT_NAIR, AUTOCANCEL_FRAME, 4);
...
set_hitbox_value(AT_NAIR, 2, HG_KNOCKBACK_SCALING, 0.20);
set_hitbox_value(AT_NAIR, 3, HG_KNOCKBACK_SCALING, 0.25);
set_hitbox_value(AT_NAIR, 4, HG_KNOCKBACK_SCALING, 0.50);
...
set_hitbox_value(AT_NAIR, 1, HG_HITSTUN_MULTIPLIER, 0.60);
set_hitbox_value(AT_NAIR, 2, HG_HITSTUN_MULTIPLIER, 0.50);
set_hitbox_value(AT_NAIR, 3, HG_HITSTUN_MULTIPLIER, 0.60);
...
set_hitbox_value(AT_NAIR, 4, HG_HITPAUSE_SCALING, 0.20);
