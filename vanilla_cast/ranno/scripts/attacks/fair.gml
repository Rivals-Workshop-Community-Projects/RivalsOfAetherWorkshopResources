...
set_hitbox_value(AT_FAIR, 3, HG_KNOCKBACK_SCALING, 0.90);
...
set_hitbox_value(AT_FAIR, 2, HG_HITPAUSE_SCALING, 0.40);
set_hitbox_value(AT_FAIR, 3, HG_HITPAUSE_SCALING, 0.25);
...
set_hitbox_value(AT_FAIR, 2, HG_VISUAL_EFFECT_Y_OFFSET, 15);
