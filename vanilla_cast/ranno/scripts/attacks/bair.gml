...
//ERROR_NO_SETTER_FOUND(AT_BAIR, HAS_WHIFF_LANDING, 4);
//ERROR_NO_SETTER_FOUND(AT_BAIR, AUTOCANCEL_FRAME, 5);
//ERROR_NO_SETTER_FOUND(AT_BAIR, LANDING_LAG, 5);
set_num_hitboxes(AT_BAIR, 3);
//ERROR_NO_SETTER_FOUND(AT_BAIR, NUM_UNIQUE_HITBOXES, 3);
...
ERROR_NO_SETTER_FOUND(AT_BAIR, 3, FINAL_BASE_KNOCKBACK, 5);
...
set_hitbox_value(AT_BAIR, 2, HG_VISUAL_EFFECT_X_OFFSET, 6);
