...
set_window_value(AT_DAIR, 4, AG_WINDOW_HAS_WHIFFLAG, 0);
...
set_window_value(AT_DAIR, 5, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_DAIR, 5, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_DAIR, 5, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_DAIR, 5, AG_WINDOW_SFX, 0);
set_window_value(AT_DAIR, 5, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_DAIR, 5, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_DAIR, 5, AG_WINDOW_INVINCIBILITY, 0);
...
set_window_value(AT_DAIR, 6, AG_WINDOW_SFX_FRAME, 4);
set_window_value(AT_DAIR, 6, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_DAIR, 6, AG_WINDOW_INVINCIBILITY, 0);
...
set_window_value(AT_DAIR, 7, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_DAIR, 7, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_DAIR, 7, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_DAIR, 7, AG_WINDOW_SFX, 0);
set_window_value(AT_DAIR, 7, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_DAIR, 7, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_DAIR, 7, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_DAIR, 8, AG_WINDOW_LENGTH, 14);
set_window_value(AT_DAIR, 8, AG_WINDOW_HSPEED, 0);
set_window_value(AT_DAIR, 8, AG_WINDOW_VSPEED, 0);
set_window_value(AT_DAIR, 8, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_DAIR, 8, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_DAIR, 8, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_DAIR, 8, AG_WINDOW_SFX, 0);
set_window_value(AT_DAIR, 8, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_DAIR, 8, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_DAIR, 8, AG_WINDOW_INVINCIBILITY, 0);
...
//ERROR_NO_SETTER_FOUND(AT_DAIR, AUTOCANCEL_FRAME, 8);
//ERROR_NO_SETTER_FOUND(AT_DAIR, LANDING_LAG, 6);
set_num_hitboxes(AT_DAIR, 3);
//ERROR_NO_SETTER_FOUND(AT_DAIR, NUM_UNIQUE_HITBOXES, 3);
...
set_hitbox_value(AT_DAIR, 3, HG_HITSTUN_MULTIPLIER, 0.90);
...
set_hitbox_value(AT_DAIR, 3, HG_EXTENDED_PARRY_STUN, 0);
