...
//ERROR_NO_SETTER_FOUND(AT_FTILT, NUM_UNIQUE_HITBOXES, 3);
...
set_hitbox_value(AT_FTILT, 1, HG_BASE_KNOCKBACK, 3.50);
...
set_hitbox_value(AT_FTILT, 2, HG_KNOCKBACK_SCALING, 0.50);
set_hitbox_value(AT_FTILT, 3, HG_KNOCKBACK_SCALING, 0.40);
...
set_hitbox_value(AT_FTILT, 3, HG_HITBOX_Y, -15);
...
set_hitbox_value(AT_FTILT, 2, HG_HITPAUSE_SCALING, 0.20);
set_hitbox_value(AT_FTILT, 3, HG_HITPAUSE_SCALING, 0.20);
