...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_SFX, asset_get("sfx_frog_fstrong"));
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITPAUSE_SCALING, 0.60);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HIT_SFX, asset_get("sfx_poison_hit_med"));
