...
set_window_value(AT_NSPECIAL, 1, AG_WINDOW_SFX, asset_get("sfx_frog_fspecial_start"));
...
set_window_value(AT_NSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_swish_medium"));
...
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, NUM_UNIQUE_HITBOXES, 1);
...
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, 1, PROJECTILE_LIFETIME, 22);
...
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, 2, PROJECTILE_LIFETIME, 0);
...
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, 3, PROJECTILE_LIFETIME, 0);
...
//ERROR_NO_SETTER_FOUND(AT_NSPECIAL, 4, PROJECTILE_LIFETIME, 0);
