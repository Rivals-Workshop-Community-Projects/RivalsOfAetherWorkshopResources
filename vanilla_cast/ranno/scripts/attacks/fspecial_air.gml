set_attack_value(AT_FSPECIAL_AIR, AG_CATEGORY, 3);
...
set_window_value(AT_FSPECIAL_AIR, 1, AG_WINDOW_SFX, asset_get("sfx_frog_dspecial_cast"));
set_window_value(AT_FSPECIAL_AIR, 1, AG_WINDOW_SFX_FRAME, 9);
set_window_value(AT_FSPECIAL_AIR, 1, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_FSPECIAL_AIR, 1, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_LENGTH, 30);
...
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_SFX, 0);
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_FSPECIAL_AIR, 2, AG_WINDOW_INVINCIBILITY, 0);
...
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_SFX, 0);
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_FSPECIAL_AIR, 3, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_LENGTH, 500);
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_HSPEED, 0);
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_VSPEED, 0);
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_HSPEED_TYPE, 0);
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_SFX, asset_get("sfx_frog_dspecial_hit_ground"));
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_FSPECIAL_AIR, 4, AG_WINDOW_INVINCIBILITY, 0);
...
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_SFX, asset_get("sfx_frog_dspecial_hit"));
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_FSPECIAL_AIR, 5, AG_WINDOW_INVINCIBILITY, 0);
set_window_value(AT_FSPECIAL_AIR, 6, AG_WINDOW_LENGTH, 36);
...
set_window_value(AT_FSPECIAL_AIR, 6, AG_WINDOW_SFX, asset_get("sfx_frog_dspecial_swallow"));
set_window_value(AT_FSPECIAL_AIR, 6, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_FSPECIAL_AIR, 6, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_FSPECIAL_AIR, 6, AG_WINDOW_INVINCIBILITY, 0);
//ERROR_NO_SETTER_FOUND(AT_FSPECIAL_AIR, HAS_COOLDOWN, 1);
//ERROR_NO_SETTER_FOUND(AT_FSPECIAL_AIR, COOLDOWN, 60);
set_num_hitboxes(AT_FSPECIAL_AIR, 1);
//ERROR_NO_SETTER_FOUND(AT_FSPECIAL_AIR, NUM_UNIQUE_HITBOXES, 1);
//set_hitbox_value(AT_FSPECIAL_AIR, 1, NUM, 0);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_WIDTH, 160);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITSTUN_MULTIPLIER, 0);
...
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_EXTENDED_PARRY_STUN, 0);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_HITBOX_GROUP, 0);
set_hitbox_value(AT_FSPECIAL_AIR, 1, HG_FORCE_FLINCH, 0);
