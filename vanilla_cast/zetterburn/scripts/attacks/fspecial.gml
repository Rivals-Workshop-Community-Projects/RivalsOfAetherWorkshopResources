...
//ERROR_NO_SETTER_FOUND(AT_FSPECIAL, COOLDOWN, 45);
...
set_hitbox_value(AT_FSPECIAL, 1, HG_KNOCKBACK_SCALING, 0.10);
set_hitbox_value(AT_FSPECIAL, 2, HG_KNOCKBACK_SCALING, 0.10);
...
//ERROR_NO_SETTER_FOUND(AT_FSPECIAL, 2, PROJECTILE_LIFETIME, 60);
