...
set_window_value(AT_NSPECIAL, 5, AG_WINDOW_VSPEED_TYPE, 0);
...
set_window_value(AT_NSPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_zap"));
...
set_hitbox_value(AT_NSPECIAL, 1, HG_BASE_KNOCKBACK, 8.50);
...
set_hitbox_value(AT_NSPECIAL, 2, HG_EXTRA_CAMERA_SHAKE, 4);
