...
set_window_value(AT_FSTRONG, 2, AG_WINDOW_HSPEED, 4.50);
...
//ERROR_NO_SETTER_FOUND(AT_FSTRONG, NUM_UNIQUE_HITBOXES, 3);
...
set_hitbox_value(AT_FSTRONG, 2, HG_KNOCKBACK_SCALING, 0.90);
set_hitbox_value(AT_FSTRONG, 3, HG_KNOCKBACK_SCALING, 1.20);
...
set_hitbox_value(AT_FSTRONG, 1, HG_HITSTUN_MULTIPLIER, 0.25);
...
set_hitbox_value(AT_FSTRONG, 2, HG_HITPAUSE_SCALING, 0.50);
set_hitbox_value(AT_FSTRONG, 3, HG_HITPAUSE_SCALING, 0.50);
...
set_hitbox_value(AT_FSTRONG, 3, HG_EXTRA_CAMERA_SHAKE, 2);
