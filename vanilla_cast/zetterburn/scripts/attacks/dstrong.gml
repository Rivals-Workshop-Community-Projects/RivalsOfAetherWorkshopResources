...
set_window_value(AT_DSTRONG, 7, AG_WINDOW_HSPEED_TYPE, 0);
...
set_hitbox_value(AT_DSTRONG, 2, HG_EFFECT, 3);
set_hitbox_value(AT_DSTRONG, 3, HG_EFFECT, 2);
...
set_hitbox_value(AT_DSTRONG, 1, HG_HITSTUN_MULTIPLIER, 0.25);
...
set_hitbox_value(AT_DSTRONG, 2, HG_HITPAUSE_SCALING, 0.50);
set_hitbox_value(AT_DSTRONG, 3, HG_HITPAUSE_SCALING, 0.50);
...
set_hitbox_value(AT_DSTRONG, 3, HG_HIT_SFX, asset_get("sfx_burnconsume"));
