...
set_window_value(AT_DSPECIAL, 3, AG_WINDOW_SFX, asset_get("sfx_zetter_downb"));
...
set_window_value(AT_DSPECIAL, 4, AG_WINDOW_SFX, asset_get("sfx_burnapplied"));
...
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSPECIAL, 6, AG_WINDOW_SFX, asset_get("sfx_burnend"));
...
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_HAS_SFX, 0);
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_SFX, 0);
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_DSPECIAL, 7, AG_WINDOW_INVINCIBILITY, 0);
...
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_VSPEED_TYPE, 0);
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_HAS_SFX, 1);
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_SFX, asset_get("sfx_land_heavy"));
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_SFX_FRAME, 0);
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_HAS_WHIFFLAG, 0);
set_window_value(AT_DSPECIAL, 8, AG_WINDOW_INVINCIBILITY, 0);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_EFFECT, 1);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_HITPAUSE_SCALING, 0.75);
...
set_hitbox_value(AT_DSPECIAL, 3, HG_EXTRA_CAMERA_SHAKE, 4);
