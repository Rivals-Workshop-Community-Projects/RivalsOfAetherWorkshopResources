...
//ERROR_NO_SETTER_FOUND(AT_FAIR, HAS_WHIFF_LANDING, 10);
//ERROR_NO_SETTER_FOUND(AT_FAIR, AUTOCANCEL_FRAME, 24);
//ERROR_NO_SETTER_FOUND(AT_FAIR, LANDING_LAG, 6);
...
set_hitbox_value(AT_FAIR, 2, HG_KNOCKBACK_SCALING, 0.20);
...
set_hitbox_value(AT_FAIR, 3, HG_WIDTH, 10);
set_hitbox_value(AT_FAIR, 3, HG_HEIGHT, 10);
...
set_hitbox_value(AT_FAIR, 3, HG_HITPAUSE_SCALING, 0.70);
...
set_hitbox_value(AT_FAIR, 3, HG_EXTRA_CAMERA_SHAKE, 2);
